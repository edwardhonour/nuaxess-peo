...
@Component({
  selector: 'app-nuaxess-home',
  templateUrl: './nuaxess-home.component.html',
  styleUrls: ['./nuaxess-home.component.scss']
})
export class NuaxessHomeComponent implements OnInit, OnDestroy
{
